...
const OurApproach = () => {
  return (
    <Box
      ...
      py={5}
    >
      <Box width={{ xs: '100%', lg: "40%"}} px={{ xs:0 , md:"4rem"}} display={'flex'} flexDirection={'column'} gap={3} justifyContent={'center'}>
        <Typography
      ...
      <Box width={{xs:'100%' , lg: "60%"}} textAlign={'center'} mt={{xs: 5, md: 0}}>
        <Img src={HomeImg} />
      </Box>
    </Box>
  );
